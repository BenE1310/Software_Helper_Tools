...
set /a BN=1
set /a PN=3
echo Creating Databases For VSIL Mode
set CDBase="C:\Windows\Temp\CDBase.sql"
del %CDBase%
MD C:\FireBoltDB

for %%A in (
			FireBolt_BMCConfigDB_VSIL_1
			FireBolt_BMCConfigDB_VSIL_2
			FireBolt_BMCConfigDB_VSIL_3
			FireBolt_BMCConfigDB_VSIL_4
			FireBolt_FaultsDB_VSIL_1
			FireBolt_FaultsDB_VSIL_2
			FireBolt_FaultsDB_VSIL_3
			FireBolt_FaultsDB_VSIL_4
			FireBolt_PolicyDB_VSIL_1
			FireBolt_PolicyDB_VSIL_2
			FireBolt_PolicyDB_VSIL_3
			FireBolt_PolicyDB_VSIL_4
			FireBolt_ReportingDB_VSIL_1
			FireBolt_ReportingDB_VSIL_2
			FireBolt_ReportingDB_VSIL_3
			FireBolt_ReportingDB_VSIL_4
) do (
(
