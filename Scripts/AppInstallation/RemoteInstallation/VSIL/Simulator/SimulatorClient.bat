...
:logo
cls
title VSIL Simulator Client Version Update 
echo.  
...
IF not exist "%~dp0..\..\Zip\Simulator_Client.7z" (goto NoSource)
...
:Simulator_Client
echo Installing VSIL Simulator Client, Please Wait...
("%~dp0..\..\Tools\7z.exe" x "%~dp0..\..\Zip\Simulator_Client.7z" -o"%DestPath%" -y) 
...
echo.
echo.
echo Error! Failed to update Simulator_Client folder.
echo        Make sure you are not running any process
echo.
goto eof
:NoSource
echo.
echo [%~dp0..\..\Zip\Simulator_Client.7z] Not Exist
