...
:logo
cls
title VSIL Simulator Server Version Update 
echo.  
...
IF not exist "%~dp0..\..\Zip\Simulator_Server.7z" (goto NoSource)
...
("%~dp0..\..\Tools\7z.exe" x "%~dp0..\..\Zip\Simulator_Server.7z" -o"%DestPath%" -y) 
...
echo.
echo.
echo Error! Failed to update Simulator_Server folder.
echo        Make sure you are not running any process
echo.
goto eof
:NoSource
echo.
echo [%~dp0..\..\Zip\Simulator_Server.7z] Not Exist-
