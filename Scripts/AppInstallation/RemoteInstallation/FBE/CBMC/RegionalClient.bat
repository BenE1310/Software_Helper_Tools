...
psservice \\FB-218-%PN% stop "FBE Watchdog REGIONAL"
pskill \\FB-218-%PN% IronDomeMdrsAgent.exe
pskill \\FB-218-%PN% LoginApp.exe
pskill \\FB-218-%PN% FBETrainerClient.exe
pskill \\FB-218-%PN% IronDomeFBERegionalMaintenance.exe
pskill \\FB-218-%PN% FBEIronDomeRegionalBMCOperationalClient.exe
pskill \\FB-218-%PN% FBEIronDomeTrainerClient.exe
...
psservice \\FB-218-%PN% start "FBE Watchdog REGIONAL"
goto EOF
